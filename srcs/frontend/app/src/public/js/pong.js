...
// Define a function to handle WebSocket initialization
function initWebSocket(ipAddress) {
    var socket = new WebSocket('ws://' + ipAddress + ':8000/ws/pong/');
    // Other WebSocket code here
...
fetch(apiEndpoint + 'get-ip-address/')
    .then(response => {
    ...
    .then(data => {
        ...
        // Call the WebSocket initialization function with the retrieved IP address
